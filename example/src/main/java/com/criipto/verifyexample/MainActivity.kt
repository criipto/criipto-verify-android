...
import com.criipto.verify.eid.MitID
import com.criipto.verify.eid.Mock
import com.criipto.verify.eid.NoBankID
import com.criipto.verify.eid.SeBankID
    ...
    Box(
      ...
      Row(
        ...
        Column(
          ...
          Button(onClick = {
            onLogin?.invoke(SeBankID.selectorPage().withMessage("hello!"))
          }, modifier = buttonModifier) {
            Text(text = "Login with SE BankID")
          }

          Button(onClick = {
            onLogin?.invoke(NoBankID.substantial())
          }, modifier = buttonModifier) {
